...
namespace testconnexionrpi
{
    public class CommunicationWithServer
    {
        ...
        #region Constructors
        public CommunicationWithServer(MainPage paramModel)
        {
        ...
        private async void WaitForData(StreamSocket socket)
        {
            ...
            try
            {
                ...
                if (msg != "")
                {
                    this.MSenseHAT.SayInformationReply(msg, this.MessageCommand);
                }
