...
namespace RaspiHomeSpeechNSynthetize.Speech
{
    public class Speecher
    {
        ...
        public Speecher()
        {
            ...
            this.ComToServer = new CommunicationWithServer();
        ...
        private void SendBrutCommand(string brutCommand)
        {
            ...
            string reply = this.ComToServer.SendCommand(brutCommand);            
            this.RhSynt.RaspiGiveInformation(this.RhSynt.SetProprelyInformations(reply));
