...
using RaspiHomeTabletteWindows.Menu.MenuToolbar;
using System.Collections.ObjectModel;
using RaspiHomeTabletteWindows.Module.Home;
using RaspiHomeTabletteWindows.Module.GlobalSetup;
using RaspiHomeTabletteWindows.Module.Information;
...
namespace RaspiHomeTabletteWindows
{
    ...
    public partial class MenuView : UserControl
    {
        ...
        public MenuView(Page p)
        {
            ...
            SetWindowsSize(p.Width, p.Height);
